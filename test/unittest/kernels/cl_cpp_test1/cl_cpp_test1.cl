...
__kernel void utilityClampIntTest(zivc::GlobalPtr<int32b> inout_i1,
                                  zivc::GlobalPtr<int2> inout_i2,
                                  zivc::GlobalPtr<int3> inout_i3,
                                  zivc::GlobalPtr<int4> inout_i4,
                                  zivc::GlobalPtr<int8> inout_i8,
                                  zivc::GlobalPtr<int16> inout_i16)
{
  const size_t index = zivc::getGlobalIdX();
  if (index != 0)
    return;
  ...
  // clamp
  {
    ...
    {
      const int32b x = inout_i1[0];
      const int32b y = zivc::clamp(x, lo, hi);
      inout_i1[0] = y;
    }
    {
      const int32b x = inout_i1[1];
      const int32b y = zivc::clamp(x, lo, hi);
      inout_i1[1] = y;
    }
    {
      const int32b x = inout_i1[2];
      const int32b y = zivc::clamp(x, lo, hi);
      inout_i1[2] = y;
    }
  }
  {
    ...
    {
      const int2 x = inout_i2[0];
      const int2 y = zivc::clamp(x, lo, hi);
      inout_i2[0] = y;
    }
    {
      const int2 x = inout_i2[1];
      const int2 y = zivc::clamp(x, lo, hi);
      inout_i2[1] = y;
    }
  }
...
__kernel void utilityMaxMinIntTest(zivc::GlobalPtr<int32b> inout_i1,
                                   zivc::GlobalPtr<int2> inout_i2,
                                   zivc::GlobalPtr<int3> inout_i3,
                                   zivc::GlobalPtr<int4> inout_i4,
                                   zivc::GlobalPtr<int8> inout_i8,
...
__kernel void utilityUpsampleIntTest(zivc::GlobalPtr<int32b> inout_i1,
                                     ...
                                     zivc::GlobalPtr<int16> out_i16)
{
  ...
  const int16b hi = static_cast<int16b>(inout_i1[0]);
  ...
  }
  {
    // v2
    {
      const short2 x = zivc::makeShort2(hi);
  ...
  }
  {
    // v3
    {
      const short3 x = zivc::makeShort3(hi);
  ...
  }
  {
    // v4
    {
      const short4 x = zivc::makeShort4(hi);
  ...
  }
  {
    // v8
    {
      const short8 x = zivc::makeShort8(hi);
  ...
  }
  {
    // v16
    {
      const short16 x = zivc::makeShort16(hi);
...
__kernel void utilityClampUintTest(zivc::GlobalPtr<uint32b> inout_i1,
                                   zivc::GlobalPtr<uint2> inout_i2,
                                   zivc::GlobalPtr<uint3> inout_i3,
                                   zivc::GlobalPtr<uint4> inout_i4,
                                   zivc::GlobalPtr<uint8> inout_i8,
                                   zivc::GlobalPtr<uint16> inout_i16)
{
  const size_t index = zivc::getGlobalIdX();
  if (index != 0)
    return;
  ...
  // clamp
  {
    ...
    {
      const uint32b x = inout_i1[0];
      const uint32b y = zivc::clamp(x, lo, hi);
      inout_i1[0] = y;
    }
    {
      const uint32b x = inout_i1[1];
      const uint32b y = zivc::clamp(x, lo, hi);
      inout_i1[1] = y;
    }
  }
...
__kernel void utilityMaxMinUintTest(zivc::GlobalPtr<uint32b> inout_i1,
                                    zivc::GlobalPtr<uint2> inout_i2,
                                    zivc::GlobalPtr<uint3> inout_i3,
                                    zivc::GlobalPtr<uint4> inout_i4,
                                    zivc::GlobalPtr<uint8> inout_i8,
...
__kernel void utilityClzUIntTest(zivc::GlobalPtr<uint32b> inout_i1,
                                 zivc::GlobalPtr<uint2> inout_i2,
                                 zivc::GlobalPtr<uint3> inout_i3,
                                 zivc::GlobalPtr<uint4> inout_i4,
                                 zivc::GlobalPtr<uint8> inout_i8,
...
__kernel void utilityPopcountUIntTest(zivc::GlobalPtr<uint32b> inout_i1,
                                      zivc::GlobalPtr<uint2> inout_i2,
                                      zivc::GlobalPtr<uint3> inout_i3,
                                      zivc::GlobalPtr<uint4> inout_i4,
                                      zivc::GlobalPtr<uint8> inout_i8,
...
__kernel void utilityRotateUIntTest(zivc::GlobalPtr<uint32b> inout_i1,
                                    zivc::GlobalPtr<uint2> inout_i2,
                                    zivc::GlobalPtr<uint3> inout_i3,
                                    zivc::GlobalPtr<uint4> inout_i4,
                                    zivc::GlobalPtr<uint8> inout_i8,
...
__kernel void utilityUpsampleUintTest(zivc::GlobalPtr<uint32b> inout_i1,
                                      zivc::GlobalPtr<uint2> out_i2,
                                      zivc::GlobalPtr<uint3> out_i3,
                                      zivc::GlobalPtr<uint4> out_i4,
                                      zivc::GlobalPtr<uint8> out_i8,
                                      zivc::GlobalPtr<uint16> out_i16)
{
  ...
  const uint16b hi = static_cast<uint16b>(inout_i1[0]);
  constexpr uint16b lo = 0b0000'1111'0000'1111u;
  {
    // v1
    {
  ...
  }
  {
    // v2
    {
      const ushort2 x = zivc::makeUShort2(hi);
      constexpr ushort2 y = zivc::makeUShort2(lo);
  ...
  }
  {
    // v3
    {
      const ushort3 x = zivc::makeUShort3(hi);
      constexpr ushort3 y = zivc::makeUShort3(lo);
  ...
  }
  {
    // v4
    {
      const ushort4 x = zivc::makeUShort4(hi);
      constexpr ushort4 y = zivc::makeUShort4(lo);
  ...
  }
  {
    // v8
    {
      const ushort8 x = zivc::makeUShort8(hi);
      constexpr ushort8 y = zivc::makeUShort8(lo);
  ...
  }
  {
    // v16
    {
      const ushort16 x = zivc::makeUShort16(hi);
      constexpr ushort16 y = zivc::makeUShort16(lo);
...
__kernel void utilityAbsFloatTest(zivc::GlobalPtr<float> inout_i1,
                                  ...
                                  zivc::GlobalPtr<float16> inout_i16)
{
  ...
  // abs
  {
    // abs v1
    {
      const float x = inout_i1[0];
      const float y = zivc::abs(x);
      inout_i1[0] = y;
    }
    {
      const float x = inout_i1[1];
      const float y = zivc::abs(x);
      inout_i1[1] = y;
    }
  }
...
__kernel void utilityClampFloatTest(zivc::GlobalPtr<float> inout_i1,
                                    zivc::GlobalPtr<float2> inout_i2,
                                    zivc::GlobalPtr<float3> inout_i3,
                                    zivc::GlobalPtr<float4> inout_i4,
                                    zivc::GlobalPtr<float8> inout_i8,
...
__kernel void utilityMaxMinFloatTest(zivc::GlobalPtr<float> inout_i1,
                                     zivc::GlobalPtr<float2> inout_i2,
                                     zivc::GlobalPtr<float3> inout_i3,
                                     zivc::GlobalPtr<float4> inout_i4,
                                     zivc::GlobalPtr<float8> inout_i8,
