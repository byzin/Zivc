...
template <std::size_t kN, typename KernelInitParam>
void testCbrt(const KernelInitParam& kernel_params,
              const std::string_view label,
              const std::string_view func_name) 
{
  const zivc::SharedContext context = ztest::createContext();
  ...
  // output1
  {
    ...
    // 
    const std::vector expected_list = ztest::loadExpectedList<cl_float>("resources/math_cbrtf_reference.bin", x_list.size());
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, sqrtV1FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, sqrtV2FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, sqrtV3FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, sqrtV4FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, sqrtV8FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, sqrtV16FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, rsqrtV1FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, rsqrtV2FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, rsqrtV3FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, rsqrtV4FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, rsqrtV8FallbackTestKernel, 1);
...
{
  const zivc::KernelInitParams kernel_params = ZIVC_CREATE_KERNEL_INIT_PARAMS(cl_cpp_test_math_power, rsqrtV16FallbackTestKernel, 1);
...
TEST(ClCppTest, MathImplCbrtV1Test)
{
  ...
  ::testCbrt<1>(kernel_params, "cbrtV1TestKernel", "cbrtV1");
}
