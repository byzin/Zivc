...
void testCeil(const KernelInitParam& kernel_params,
              ...
              const std::string_view func_name) 
{
  ...
  // output1
  {
    ...
    // 
    const std::vector expected_list = ztest::loadExpectedList<cl_float>("resources/math_ceilf_reference.bin", x_list.size());
...
TEST(ClCppTest, MathImplCeilV1Test)
{
  ...
  ::testCeil<1>(kernel_params, "ceilV1TestKernel", "ceilV1");
}
