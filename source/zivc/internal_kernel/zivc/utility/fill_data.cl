...
class FillData
{
 public:
  ...
  void set(const Type data, const size_t index) noexcept;

 private:
  static constexpr size_t kCapacityInBytes = FillInfo::dataCapacityInBytes();
  static constexpr size_t kCapacity = kCapacityInBytes / sizeof(Type);


  Type storage_[kCapacity];
};
